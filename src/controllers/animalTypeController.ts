...
import { toAnimalTypeResponse } from '../mappers/animalTypeMapper';
import { AnimalTypeRequestDto } from '../types/animalType';
...
export class AnimalTypeController {
  ...
  async getAnimalTypeById(req: Request, res: Response) {
    ...
    res.status(200).json(toAnimalTypeResponse(type));
  }
  ...
  async createAnimalType(req: Request, res: Response) {
    ...
    res.status(201).json(toAnimalTypeResponse(animalType));
  }
  ...
  async updateAnimalType(req: Request, res: Response) {
    ...
    res.status(200).json(toAnimalTypeResponse(animalType));
  }
